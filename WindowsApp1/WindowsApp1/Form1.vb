...
1:      Me.Show()
    ...
    Private Sub DLLs_SelectedIndexChanged(sender As Object, e As EventArgs) Handles DLL.SelectedIndexChanged
    ...
    Private Sub Button8_Click(sender As Object, e As EventArgs) Handles Button8.Click
        Process.Start("https://discord.gg/qvrXysJgx7")
    End Sub
